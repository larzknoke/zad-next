    ...
    <div className="mx-auto">
      ...
      <div className="px-[15%] my-16">
        ...
        <p>
          ...
          Vielzahl von Berufsgruppen im Gesundheitswesen. Deshalb erstreckt sich
          unser Service – neben den so genannten Sonstigen Leistungserbringern –
          auch auf einen Großteil der Heilberufe. So profitieren neben Rettungs-
          und ambulanten Krankenpflegediensten auch Ärzte, Zahnärzte oder
          Therapeuten durch die Entlastung von Verwaltungsaufgaben und
        ...
        <p>
          Gerne entwerfen wir ein individuell auf Ihre Bedürfnisse abgestimmtes
          Servicekonzept, das auch den Vorstellungen Ihrer Patienten gerecht
          wird.
        </p>
      </div>
    </div>
